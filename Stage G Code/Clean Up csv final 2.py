...
def import_csv(db, batch):
    path = 'X:/Users/Josh/Desktop/POKER PROJECT/StageF - Dump Tables/cash_hand_player_statistics/16_batch' + str(batch) + '_' + str(db) + '.csv'
